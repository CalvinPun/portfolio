...
export function SocialLinks({ github, linkedin, instagram, youtube, email }: SocialLinksProps) {
  ...
  return (
    <nav className="mt-7 flex flex-wrap items-center gap-6" aria-label="Social and contact links">
      <a
        href={github}
      ...
      <div className="flex items-center gap-2">
        <button
          type="button"
          className={`${iconWrapClass()} cursor-pointer border-0 bg-transparent p-0`}
        ...
        <span
          className="font-hand text-base text-stone-600"
          aria-live="polite"
          aria-atomic="true"
        >
          {copied ? "Copied!" : ""}
