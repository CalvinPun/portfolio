  ...
  return (
    <div
      className={[
        ...
        "relative flex h-[9.25rem] w-[9.25rem] shrink-0 flex-col overflow-visible rounded-sm",
        "bg-gradient-to-b from-[#fff8fb] to-[#ffeef4]",
      ].join(" ")}
    >
      <div className="tape tape-sticky-top" aria-hidden />
      <div className="flex min-h-0 w-full flex-1 flex-col items-center justify-center overflow-auto px-1 pb-1 pt-6">
        <div
